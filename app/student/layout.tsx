      ...
      <div className="app-shell-grid">
        <aside className="hidden border-r border-[var(--border)] bg-[var(--surface-muted)] px-4 py-6 md:block" aria-label="Student navigation">
          ...
          <nav className="grid gap-1 text-sm font-semibold text-[var(--muted)]">
            <a className="flex items-center gap-3 rounded-md px-3 py-2.5 hover:bg-white" href="/student">
            ...
            <a className="flex items-center gap-3 rounded-md px-3 py-2.5 hover:bg-white" href="/student/attempts/att_active/exam">
