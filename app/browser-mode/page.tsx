    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-5 py-10">
        ...
        <Card className="mt-6 grid gap-4 text-sm leading-7 text-[var(--muted)]">
          ...
          <p>Safe Exam Browser is available as a separate gated delivery mode. It validates BEK/CK request hashes server-side, while Browser Mode remains moderation evidence only.</p>
        </Card>
      </main>
    </>
  );
