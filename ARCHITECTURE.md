...
- `answer-uploads`: one current student PDF per root/main-question upload slot plus generated blank-placeholder PDFs.
...
placeholder. Blank submissions create a generated private PDF artifact so markers can distinguish deliberate blank
work from missing/lost uploads. Subquestions and deeper parts are marked inside the main question context; they do not
get separate student upload slots.
