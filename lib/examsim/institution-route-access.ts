...
const OWNER_ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  { permission: "student_data", matches: (path) => path === "/owner/students" || path.startsWith("/owner/students/") },
  { permission: "student_data", matches: (path) => path === "/owner/cohorts" || path.startsWith("/owner/cohorts/") },
