        ...
        messages: [
          {
            ...
            content: [
              ...
              "- CRITICAL: Escape all `<` and `>` characters that are NOT part of a valid HTML tag as `&lt;` and `&gt;`.",
              "- Inline math must be preserved as raw LaTeX ($...$) inside the paragraph. Do not wrap in extra spans unless needed for complex environments.",
              "- Display math should use <div class=\"math\">...</div>.",
              "",
              "Allowed HTML:",
              "<p>, <strong>, <em>, <br>, <ol>, <ul>, <li>, <div class=\"math\">",
              "",
              "==================================================",
